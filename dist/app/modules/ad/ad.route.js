...
router.post("/", managers, upload.single("image"), validation(createAdValidation), AdController.create);
router.patch("/:id", managers, upload.single("image"), validation(updateAdValidation), AdController.update);
