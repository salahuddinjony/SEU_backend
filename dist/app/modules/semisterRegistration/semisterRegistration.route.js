...
router.post("/create-semister-registration", authorizationValidate(UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.FACULTY, UserRole.STUDENT), validation(semisterRegisterationValidationSchema.semisterRegisterationValidation), // Validate the request body against the createSemesterRegistrationPayloadSchema
SemesterRegistrationController.createSemesterRegistration);
// Route for getting all semester registrations
router.get("/get-all-semister-registrations", authorizationValidate(UserRole.SUPER_ADMIN, UserRole.ADMIN), SemesterRegistrationController.getAllSemesterRegistrations);
// Route for getting an semester registration by ID
router.get("/get-semister-registration/:id", authorizationValidate(UserRole.SUPER_ADMIN, UserRole.ADMIN), SemesterRegistrationController.getSemesterRegistrationById);
// Route for updating semester registration info
router.patch("/update-semister-registration/:id", authorizationValidate(UserRole.SUPER_ADMIN, UserRole.ADMIN), validation(semisterRegisterationValidationSchema.semisterRegisterationUpdateValidation), SemesterRegistrationController.updateSemesterRegistrationInfo);
...
//# sourceMappingURL=semisterRegistration.route.js.map