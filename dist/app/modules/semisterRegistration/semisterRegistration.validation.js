...
const semisterRegisterationBaseSchema = z
    ...
    .strict();
const semisterRegisterationValidation = semisterRegisterationBaseSchema.refine((data) => {
    return (data.endDate > data.startDate &&
        data.startDate >= getStartOfToday() &&
        Object.keys(data).length > 0);
}, {
    message: "End Date must be after Start Date and start date must be today or a future date",
...
//# sourceMappingURL=semisterRegistration.validation.js.map