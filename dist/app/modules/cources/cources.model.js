...
}, { _id: false }); // Set _id to false to prevent creating an _id for each subdocument
...
const assignCourcesToFacultiesSchema = new Schema({
...
applyExcludeFields(CourseSchema, [
    "isDeleted",
...
export const AssignCourcesToFacultiesModel = model("AssignCourcesToFaculties", assignCourcesToFacultiesSchema);
//# sourceMappingURL=cources.model.js.map