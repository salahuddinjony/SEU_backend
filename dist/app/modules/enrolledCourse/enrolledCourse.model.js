...
const gradeEnum = ["A+", "A", "A-", "B", "C", "D", "F", "N/A"];
export const CourseMarksSchema = new Schema({
...
applyExcludeFields(EnrolledCourseSchema, ["isDeleted"]);
export const EnrolledCourseModel = model("EnrolledCourse", EnrolledCourseSchema);
//# sourceMappingURL=enrolledCourse.model.js.map