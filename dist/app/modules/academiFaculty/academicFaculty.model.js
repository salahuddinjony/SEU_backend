...
const academicFaultySchema = new Schema({
    facultyId: {
        type: String,
...
applyExcludeFields(academicFaultySchema, ['isDeleted']);
...
//     }
// });
const AcademicFacultyModel = model('AcademicFaculty', academicFaultySchema);
export default AcademicFacultyModel;
//# sourceMappingURL=academicFaculty.model.js.map